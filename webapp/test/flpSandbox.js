		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aluno11",
									"targetURL": "#AppFioriAluno11appfiorialuno11-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AppFioriAluno11appfiorialuno11-display": {
								"semanticObject": "AppFioriAluno11appfiorialuno11",
								"action": "display",
								"description": "AppFioriAluno11 application.",
								"title": "Aluno11",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=AppFioriAluno11.appfiorialuno11",
									"url": sap.ui.require.toUrl("AppFioriAluno11/appfiorialuno11")
								}
							}
						}
					}
